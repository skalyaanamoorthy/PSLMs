...
python ../inference_scripts/esmif.py --db_loc '../data/preprocessed/ssym_mapped.csv' --output '../data/inference/ssym_mapped_preds.csv'
...
python ../inference_scripts/esmif.py --db_loc '../data/preprocessed/fireprot_mapped.csv' --output '../data/inference/fireprot_mapped_preds.csv' --multimer
python ../inference_scripts/esmif.py --db_loc '../data/preprocessed/fireprot_mapped.csv' --output '../data/inference/fireprot_mapped_preds.csv' --multimer --device='cpu'
python ../inference_scripts/esmif.py --db_loc '../data/preprocessedssym_mapped.csv' --output '../data/inference/ssym_mapped_preds.csv' --multimer
