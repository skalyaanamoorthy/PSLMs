...
python ../inference_scripts/esmif.py --multimer --db_loc '../data/s669_mapped.csv' --output '../data/s669_mapped_preds.csv'
if ! test -e '../data/fireprot_mapped_preds.csv'; then cp '../data/fireprot_mapped.csv' '../data/fireprot_mapped_preds.csv'; fi
python ../inference_scripts/esmif.py --multimer --db_loc '../data/fireprot_mapped.csv' --output '../data/fireprot_mapped_preds.csv'
